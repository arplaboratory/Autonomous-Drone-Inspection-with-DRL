...
class YoloDetector
{
 ...
 private:
  ...
  /*!
   * Callback of compressedcamera.
   * @param[in] msg image pointer.
   */
  void compressedCameraCallback(const sensor_msgs::CompressedImageConstPtr& msg);
   ...
   * @return true if successful.
   */
  bool publishDetectionImage(const cv::Mat& detectionImage, ros::Time image_stamp);
  ...
  ros::Subscriber compressedImageSubscriber_;
  //compressed_image_transport::CompressedSubscriber compressedImageSubscriber_;
